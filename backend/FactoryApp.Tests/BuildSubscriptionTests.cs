...
public class BuildSubscriptionTests : IAsyncLifetime
{
    ...
    public async Task SubscriptionResolver_FiltersEventsByBuildId()
    {
        ...
        await foreach (var update in BuildSubscription.BuildStatusUpdated(buildId.ToString(), statusChangedEvent))
        {
            updates.Add(update);
        }
    ...
    public async Task TestRunSubscriptionResolver_FiltersEventsByBuildId()
    {
        ...
        await foreach (var update in BuildSubscription.TestRunCompleted(buildId.ToString(), testRunEvent))
        {
            updates.Add(update);
        }
